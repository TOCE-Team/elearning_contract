...
/// Wrap Skill when finish course and add skill
#[derive(BorshDeserialize, BorshSerialize, Deserialize, Serialize, Clone)]
#[serde(crate = "near_sdk::serde")]
pub struct WrapSkill {
...
pub trait SkillFeatures {
  ...
  fn add_skill(&mut self, student: AccountId, skill_id: SkillId, credit: u32);
}

pub trait EnumSkill {
  /// Get all skills per user
  fn get_all_skills_per_user(&self, user_id: AccountId) -> HashMap<SkillId, u32>;
